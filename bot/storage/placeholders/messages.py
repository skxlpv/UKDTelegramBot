...
Мета цого бота - полегшити пошук розкладу для всіх відвідувачів Університету Короля Данила!
Для отримання детальнішої інформації про функціонал, можете перейти на сторінку допомоги /help.\n
Отож, розпочнімо!⚡️"""
