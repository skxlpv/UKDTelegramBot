...
Щоб отримати детальнішу інформації про весь доступний функціонал бота, можете перейти на сторінку допомоги за командою /help.

Отож, розпочнімо!⚡️"""

#    UTILS
# render_schedule
NO_CLASSES = '\nНа заданому проміжку часу у вас немає пар, хорошого відпочинку!'
BREAK_LINE = '_' * 35
